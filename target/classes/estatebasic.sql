...
CREATE DATABASE `estatebasic` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `estatebasic`;
...
-- SELECT *  FROM ((((building INNER JOIN district ON building.districtid = district.id)
